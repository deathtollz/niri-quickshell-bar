...
PanelWindow {
    ...
    WlrLayershell.namespace: "omaniri-arch-updater"
    ...
    Process {
        ...
        command: ["bash", "-c", "omaniri-launch-floating-terminal-with-presentation 'gum confirm \"Update packages?\" && { AUR=$(command -v paru || command -v yay); $AUR -Syu --noconfirm; }'"]
    }
